...
serveurSocket.onmessage = (event) => {
    ...
    if (data.type === "dataPage") {
        ...
        if (moyG < 40) {
            papetWrapper.innerHTML = `<img src="/workshop_3/public/mobile/image/papet_bad.png" alt="papeteries" class="image">`
            papetMoodTextWrapper.innerHTML = `<p class="paragraph-bold">Le bâtiment est triste</p>`
        } else if ((moyG > 40) && (moyG < 60)) {
            papetWrapper.innerHTML = `<img src="/workshop_3/public/mobile/image/papet_normal.png" alt="papeteries" class="image">`
            papetMoodTextWrapper.innerHTML = `<p class="paragraph-bold">Le bâtiment est paisible</p>`
        } else {
            papetWrapper.innerHTML = `<img src="/workshop_3/public/mobile/image/papet_good.png" alt="papeteries" class="image">`
